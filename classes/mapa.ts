...
export class Mapa {
    ...
    moverMarcador(nuevoMarcador: { id: string, lng: number, lat: number}) {
        this.marcadores[nuevoMarcador.id].lng = nuevoMarcador.lng;
        this.marcadores[nuevoMarcador.id].lat = nuevoMarcador.lat;
    }
